...
export default function Page() {
    ...
    const validationSchema = z.object({
        ...
        username: z.string({
			...
			invalid_type_error: "Username must be in string format."
		}).min(8, {message: "Username must be contains at least 8 characters."}),
                                ...
                                <form onSubmit={handleSubmit(handleFormSubmit)}>
                                    ...
                                    <div className="pb-[15px] md:pb-[15px]">
                                        <input 
                                            ...
                                            {...register("username")}
                                        />
                                        {errors.username && (<div className="ws-input-error">{errors.username.message}</div>)}
                                    </div>
                                    <div className="pb-[15px] md:pb-[15px]">
                                        <input 
                                            type="email" 
