...
const dump_testimonials_homepage = [
    {
        id: 1,
        stars: 5,
        testimonial_content: "Working with TPlus org has been a game-changer for our marketing strategy. The team's innovative approach and dedication have significantly boosted our online presence. Highly recommended!",
        testimonial_name: "Sarah Johnson",
        testimonial_person_photo: "/images/testimonials/sarah-johnson.jpg",
        testimonial_designation: "Marketing Manager",
    },
    {
        id: 2,
        stars: 4,
        testimonial_content: "KBC pvt ltd, exceeded our expectations in delivering top-notch solutions tailored to our business needs. Their professionalism and attention to detail are unmatched. Thank you for your outstanding service!",
        testimonial_name: "John Smith",
        testimonial_person_photo: "/images/testimonials/john-smith.jpg",
        testimonial_designation: "CEO",
    },
    {
        id: 3,
        stars: 5,
        testimonial_content: "I've had the pleasure of collaborating with YTT Industries on several projects, and each time they've impressed me with their creativity and commitment to excellence. Their team truly understands the essence of effective design.",
        testimonial_name: "Emily Brown",
        testimonial_person_photo: "/images/testimonials/emily-brown.jpg",
        testimonial_designation: "Creative Director",
    },
    {
        id: 4,
        stars: 4,
        testimonial_content: "Choosing Taxon org for our financial advisory needs was one of the best decisions we made. Their expertise and personalized approach helped us navigate complex financial landscapes with ease. Highly satisfied!",
        testimonial_name: "Michael Davis",
        testimonial_person_photo: "/images/testimonials/michael-davis.jpg",
        testimonial_designation: "Financial Analyst",
    },
    {
        id: 5,
        stars: 5,
        testimonial_content: "I cannot speak highly enough of the professionalism and efficiency demonstrated by CTC California pvt ltd. Their HR solutions have streamlined our processes and improved employee satisfaction. A reliable partner indeed!",
        testimonial_name: "Jennifer Lee",
        testimonial_person_photo: "/images/testimonials/jennifer-lee.jpg",
        testimonial_designation: "HR Manager",
    },
];
...
const dump_quizzes_list = [
    {
        ...
        quiz_total_question: 20,
        quiz_total_marks: 200,
        quiz_display_time: "5 Mins",
        quiz_terms: ["Term 1", "Term 2", "Term 3", "Term 4"]
    },
    {
        quiz_id: "quiz_2",
        quiz_title: "Quiz on International Yoga Day",
        quiz_cover_photo: "https://placehold.co/1000x700/png",
        quiz_summary: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aliquam minima dolore. Ex recusandae enim labore quidem voluptatibus? Quae, a.",
        quiz_about_text: "Every year on December 3, the world commemorates the International Day of Persons with Disabilities (IDPD) to spread awareness and mobilise support for the rights and well-being of people with disabilities everywhere. Additionally, it aims to promote the inclusion of disabled individuals in all facets of society and increase awareness of the challenges faced by them. The day is observed annually with an array of events such as discussions, and initiatives aimed at raising awareness of the rights and dignity of people with disabilities.",
        quiz_categories: [
    ...
    {
        quiz_id: "quiz_3",
        quiz_title: "Quiz on Gandhi Jayanti",
        quiz_cover_photo: "https://placehold.co/1000x700/png",
        quiz_summary: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aliquam minima dolore. Ex recusandae enim labore quidem voluptatibus? Quae, a.",
        quiz_about_text: "Every year on December 3, the world commemorates the International Day of Persons with Disabilities (IDPD) to spread awareness and mobilise support for the rights and well-being of people with disabilities everywhere. Additionally, it aims to promote the inclusion of disabled individuals in all facets of society and increase awareness of the challenges faced by them. The day is observed annually with an array of events such as discussions, and initiatives aimed at raising awareness of the rights and dignity of people with disabilities.",
        quiz_categories: [
            {
                category_id: "cat_6",
                category_title: "Gandhi",
                category_slug: "gandhi"
            },
        ],
        quiz_total_question: 5,
        quiz_total_marks: 10,
        quiz_display_time: "1 Mins",
        quiz_terms: ["Term 1", "Term 2", "Term 3"]
    },
    {
        quiz_id: "quiz_4",
        quiz_title: "Quiz on Swami Veveka Nand",
        quiz_cover_photo: "https://placehold.co/1000x700/png",
        quiz_summary: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aliquam minima dolore. Ex recusandae enim labore quidem voluptatibus? Quae, a.",
        quiz_about_text: "Every year on December 3, the world commemorates the International Day of Persons with Disabilities (IDPD) to spread awareness and mobilise support for the rights and well-being of people with disabilities everywhere. Additionally, it aims to promote the inclusion of disabled individuals in all facets of society and increase awareness of the challenges faced by them. The day is observed annually with an array of events such as discussions, and initiatives aimed at raising awareness of the rights and dignity of people with disabilities.",
        quiz_categories: [
            {
                category_id: "cat_7",
                category_title: "Revolution",
                category_slug: "revolution"
            },
            {
                category_id: "cat_8",
                category_title: "Revolt",
                category_slug: "revolt"
            },
        ],
        quiz_total_question: 10,
        quiz_total_marks: 100,
        quiz_display_time: "3 Mins",
        quiz_terms: ["Term 1", "Term 2", "Term 3", "Term 4", "Term 5"]
    },
    {
        quiz_id: "quiz_5",
        quiz_title: "Quiz on Indian Economy",
        quiz_cover_photo: "https://placehold.co/1000x700/png",
        quiz_summary: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aliquam minima dolore. Ex recusandae enim labore quidem voluptatibus? Quae, a.",
        quiz_about_text: "Every year on December 3, the world commemorates the International Day of Persons with Disabilities (IDPD) to spread awareness and mobilise support for the rights and well-being of people with disabilities everywhere. Additionally, it aims to promote the inclusion of disabled individuals in all facets of society and increase awareness of the challenges faced by them. The day is observed annually with an array of events such as discussions, and initiatives aimed at raising awareness of the rights and dignity of people with disabilities.",
        quiz_categories: [
        ...
        quiz_total_question: 20,
        quiz_total_marks: 200,
        quiz_display_time: "6 Mins",
        quiz_terms: ["Term 1", "Term 2"]
    },
    {
        quiz_id: "quiz_6",
        quiz_title: "Quiz on Income Tax Department Of India.",
        quiz_cover_photo: "https://placehold.co/1000x700/png",
        quiz_summary: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aliquam minima dolore. Ex recusandae enim labore quidem voluptatibus? Quae, a.",
        quiz_about_text: "Every year on December 3, the world commemorates the International Day of Persons with Disabilities (IDPD) to spread awareness and mobilise support for the rights and well-being of people with disabilities everywhere. Additionally, it aims to promote the inclusion of disabled individuals in all facets of society and increase awareness of the challenges faced by them. The day is observed annually with an array of events such as discussions, and initiatives aimed at raising awareness of the rights and dignity of people with disabilities.",
        quiz_categories: [
    ...
    },
    {
        ...
        quiz_categories: [
            {
                category_id: "cat_16",
                category_title: "Population",
                category_slug: "population"
            },
            {
                category_id: "cat_17",
                category_title: "Peoples",
                category_slug: "peoples"
            },
        ],
        quiz_total_question: 10,
        quiz_total_marks: 200,
    ...
    {
        quiz_id: "quiz_8",
        quiz_title: "Quiz on National Heritage Sites",
        quiz_cover_photo: "https://placehold.co/1000x700/png",
        quiz_summary: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aliquam minima dolore. Ex recusandae enim labore quidem voluptatibus? Quae, a.",
        quiz_about_text: "Every year on December 3, the world commemorates the International Day of Persons with Disabilities (IDPD) to spread awareness and mobilise support for the rights and well-being of people with disabilities everywhere. Additionally, it aims to promote the inclusion of disabled individuals in all facets of society and increase awareness of the challenges faced by them. The day is observed annually with an array of events such as discussions, and initiatives aimed at raising awareness of the rights and dignity of people with disabilities.",
        quiz_categories: [
            ...
            },
            {
                ...
                category_slug: "forest"
            },
        ],
        quiz_total_question: 25,
